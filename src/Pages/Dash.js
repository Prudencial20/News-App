 ...
 <section className="admin-dash-right-panel">
     ...
     <div className="dash-settings">
      ...
      <div className="dash-text-area">
         ...
         <div className="upload-div">
            <p>Caption</p>
            <input value={caption} className="dash-para" type="text" onChange={e => setCaption(e.target.value)} name='caption' />
         </div>
         <div className="upload-div">
            <p>Writer</p>
            <input value={writer} onChange={e => setWriter(e.target.value)} className="dash-para" type="text" style={{marginLeft:'42px'}} />
         </div>
      </div>
      </div>
